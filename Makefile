...
# and runs natively here. This is the only automated behavioural coverage the
# project has; `make test` should pass before any commit touching ShirayukiMemory/.
